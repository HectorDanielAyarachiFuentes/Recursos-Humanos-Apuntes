...
async def main():
    ...
    try:
        q = "Basado en el archivo 'programa DG 2024.pdf', haz una lista muy detallada de los autores y sus textos correspondientes EXCLUSIVAMENTE para la UNIDAD 3. Sé específico con los nombres y los temas."
        await ask_and_save(client, q, "Desarrollo Gerencial/autores_u3.txt")
    finally:
